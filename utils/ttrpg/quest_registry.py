...
QUESTS = {
    ...
    "weight_of_the_count": {
        ...
        "npc": "senna",
        "description": "Senna the Assayer has kept secret copies of Grimstone's real yield ledgers for months. She needs them delivered to Elder Elara in Oakhaven without the Guild finding out. (Travel to Oakhaven and use `!rpg talk elara` to deliver them).",
        "requirements": {"level": 15},
    ...
    "old_pells_favour": {
        ...
        "npc": "old_pell",
        "description": "Old Pell needs an escort through a Spine pass the Guild doesn't know about — a delivery for his Silvani contacts. The Spine is not safe. That's why he needs someone. (Use `!rpg hunt` in the Spine of the World, then return to Pell).",
        "requirements": {"level": 15},
