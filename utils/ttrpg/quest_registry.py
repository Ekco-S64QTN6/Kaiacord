...
QUESTS = {
    ...
    "merchant_gambit": {
        ...
        "npc": "merchant",
        "description": "The traveling merchant needs an escort for a cargo shipment through bandit territory. Defeat a 'Road Bandit' to secure the route.",
        "requirements": {"level": 8},
        "tasks": ["kill_bandit", "talk_merchant"],
        "rewards": {"xp": 800, "gil": 300, "item": "potion_standard"},
        "completion_msg": "The merchant grins. 'Cargo arrived safe and sound. Hemlock's going to be pleased. Here's your cut.'",
    },
    "grimstone_shadows": {
        "id": "grimstone_shadows",
        "name": "Shadows Over Grimstone",
        "npc": "guard",
        "description": "The Watchtower reports constructs breaching the mine perimeter. Clear a dungeon and report back.",
        "requirements": {"level": 9},
        "tasks": ["complete_dungeon", "talk_guard"],
