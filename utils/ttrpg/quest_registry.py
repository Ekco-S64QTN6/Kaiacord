...
QUESTS = {
    ...
    "grimstone_path": {
        ...
        "npc": "hooded_figure",
        "description": "The Ironclad Guild has barricaded the Trade Road north to Grimstone. Speak to Elder Elara and the Hooded Figure, then seek a way to break the resonance lock at the Aeridor Ruins crystals.",
        "requirements": {"level": 15},
        "tasks": ["talk_elara", "talk_hooded_figure", "look_crystals"],
