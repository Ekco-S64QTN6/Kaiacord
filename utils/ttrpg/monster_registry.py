...
ENCOUNTER_TABLES = {
    ...
    "spine_of_the_world": {
        "working_tunnels": [
            ("tunnel_crawler", 20), ("abandoned_miner_ghoul", 20), ("cave_troll", 10),
            ("blind_cave_leech", 10), ("rust_lung_miner", 10), ("chittering_skitterer", 10),
            ("iron_blight_bat", 10), ("subterranean_prowler", 5), ("foremans_enforcer", 5)
        ],
        "bone_warrens": [
            ("bone_weaver_spider", 20), ("crypt_stalker", 20), ("ossuary_golem", 10),
            ("marrow_hound", 15), ("crypt_warden", 10), ("whispering_skull_swarm", 10),
            ("ash_wraith", 5), ("ossified_terror", 5), ("entombed_scholar", 5)
        ],
        "sunken_forge": [
            ("forge_fire_elemental", 20), ("slag_horror", 20), ("iron_sentinel", 10),
            ("slag_crawler_spine", 10), ("ignited_sentinel", 10), ("smoldering_ash_walker", 10),
            ("molten_slime", 10), ("brass_plated_hound", 5), ("forge_fire_wisp", 5)
        ],
        "deep_dark": [
            ("void_stalker", 20), ("abyssal_crawler", 20), ("mind_flayer_outcast", 10),
            ("void_touched_weaver", 10), ("deep_stalker", 10), ("abyssal_leech_spine", 10),
            ("eyeless_horror", 10), ("resonance_warped_troll", 5), ("the_lurking_shadow", 5)
        ],
        "heart_of_mountain": [
            ("crystal_golem", 20), ("resonance_wraith", 20), ("core_guardian", 10),
            ("pulse_walker", 10), ("crystalline_abomination", 10), ("flesh_forged_construct", 10),
            ("the_mountains_white_blood", 10), ("aeridorian_echo", 5), ("core_warped_behemoth", 5)
        ],
    },
}
