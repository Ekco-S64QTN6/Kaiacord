...
CONSUMABLES = {
    ...
    "bandage":        {"name": "Bandage",          "hp_restore": 10,  "value": 6,   "tier": 1},
    "tonic":          {"name": "Tonic",            "hp_restore": 15, "value": 20,  "tier": 2},
    "elixir":         {"name": "Elixir",           "hp_restore": 75, "value": 100, "tier": 4},
    "hi_potion":      {"name": "Hi-Potion",        "hp_restore": 50, "value": 60,  "tier": 3},
    "phoenix_down":   {"name": "Phoenix Down",     "hp_restore": 100,"value": 500, "description": "A feather of rebirth. Restores a great deal of HP.", "tier": 4},
    ...
    # SPINE LORE ITEMS
    # ══════════════════════════════════════════════════════════════
    "shift_log_page":      {"name": "Shift Log Page",       "value": 150, "description": "Day 247. Something answers when we tap the lower wall."},
    "burial_offering":     {"name": "Burial Offering",       "value": 200, "description": "An offering from a civilization without a name. The material is unclassified."},
    "forge_manifest":      {"name": "Forge Manifest",        "value": 250, "description": "A production order. 50,000 units. Delivery: Aeridor Central. Status: Pending. Date: 600 years ago."},
