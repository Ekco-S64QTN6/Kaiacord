WEAPONS = {
    ...
    # ── PHASE 2 EXPANSION (D&D, MtG, EQ, FF) ──
...
ACCESSORIES = {
    ...
    # Tier 4 — drops or quest rewards only
...
# What Hemlock sells (Tier 1 core set — Phase 2 items are drop-only or for later towns)
...
HEMLOCK_STOCK_HEADGEAR = ["worn_cap", "iron_helm", "scouts_hood", "mages_cap"]
HEMLOCK_STOCK_BOOTS    = ["worn_boots", "heavy_boots", "trackers_boots", "soft_slippers"]
