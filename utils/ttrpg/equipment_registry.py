WEAPONS = {
    ...
    'bone_woven_bow': {'name': 'Bone-Woven Bow', 'attack_bonus': 2, 'damage_die': 8, 'damage_bonus': 1, 'value': 1350, 'tier': 4, 'droppable_only': True, 'classes': ['Ranger', 'Hunter', 'Warden'], 'proc': {'name': 'Marrow Snap', 'emoji': '💀', 'die': 6, 'element': 'physical'}},
    'echo_chime_focus': {'name': 'Echo Chime Focus', 'attack_bonus': 2, 'damage_die': 8, 'damage_bonus': 1, 'value': 1400, 'tier': 4, 'droppable_only': True, 'classes': ['Mage', 'Wizard', 'Necromancer'], 'proc': {'name': 'Resonance Pulse', 'emoji': '🔔', 'die': 6, 'element': 'arcane'}},
    'soot_stained_cleaver': {'name': 'Soot-Stained Cleaver', 'attack_bonus': 2, 'damage_die': 8, 'damage_bonus': 1, 'value': 1350, 'tier': 4, 'droppable_only': True, 'classes': ['Rogue', 'Trickster', 'Shadowblade'], 'proc': {'name': 'Choking Ash', 'emoji': '🌫️', 'die': 6, 'element': 'shadow'}},
    ...
    'void_touched_longbow': {'name': 'Void-Touched Longbow', 'attack_bonus': 2, 'damage_die': 10, 'damage_bonus': 2, 'value': 2700, 'tier': 5, 'droppable_only': True, 'classes': ['Ranger', 'Hunter', 'Warden'], 'proc': {'name': 'Abyssal Arrow', 'emoji': '🌑', 'die': 8, 'element': 'void'}},
    'aeridorian_spine_staff': {'name': 'Aeridorian Spine-Staff', 'attack_bonus': 2, 'damage_die': 10, 'damage_bonus': 2, 'value': 2800, 'tier': 5, 'droppable_only': True, 'classes': ['Mage', 'Wizard', 'Necromancer'], 'proc': {'name': 'Resonance Cascade', 'emoji': '💠', 'die': 8, 'element': 'arcane'}},
    'elaras_betrayal_dagger': {'name': "Elara's Betrayal", 'attack_bonus': 2, 'damage_die': 8, 'damage_bonus': 2, 'value': 2700, 'tier': 5, 'droppable_only': True, 'classes': ['Rogue', 'Trickster', 'Shadowblade'], 'proc': {'name': 'Treachery', 'emoji': '🗡️', 'die': 8, 'element': 'shadow'}},
...
ARMOR = {
    ...
    'scouts_bone_leather': {'name': "Scout's Bone Leather", 'defense_bonus': 5, 'stat_bonus': {'dex': 1}, 'value': 1350, 'tier': 4, 'droppable_only': True, 'classes': ['Ranger', 'Hunter', 'Warden'], 'desc': 'Treated with marrow oil from the Bone Warrens. The leather is eerily light.'},
    'ash_woven_robes': {'name': 'Ash-Woven Robes', 'defense_bonus': 5, 'stat_bonus': {'int': 1}, 'value': 1400, 'tier': 4, 'droppable_only': True, 'classes': ['Mage', 'Wizard', 'Necromancer'], 'desc': 'Garments worn by the Entombed Scholars. If you listen closely, you can hear a woman apologizing.'},
    'tunnel_runners_garb': {'name': "Tunnel Runner's Garb", 'defense_bonus': 5, 'stat_bonus': {'dex': 1}, 'value': 1350, 'tier': 4, 'droppable_only': True, 'classes': ['Rogue', 'Trickster', 'Shadowblade'], 'desc': 'Worn by the miners who tried to escape. They ran in the dark. The leather remembers the route.'},
    ...
    'deep_stalkers_hide': {'name': "Deep Stalker's Hide", 'defense_bonus': 6, 'stat_bonus': {'dex': 1}, 'value': 2700, 'tier': 5, 'droppable_only': True, 'classes': ['Ranger', 'Hunter', 'Warden'], 'desc': 'Skinned from a Deep Stalker. The leather still shifts color in torchlight.'},
    'the_vessels_mantle': {'name': "The Vessel's Mantle", 'defense_bonus': 6, 'stat_bonus': {'int': 1}, 'hp_bonus': 5, 'value': 2800, 'tier': 5, 'droppable_only': True, 'classes': ['Mage', 'Wizard', 'Necromancer'], 'desc': 'A cloak of woven resonance. It was meant for the Elder who feeds the mountain.'},
    'eyeless_horrors_skin': {'name': "Eyeless Horror's Skin", 'defense_bonus': 6, 'stat_bonus': {'dex': 1}, 'value': 2700, 'tier': 5, 'droppable_only': True, 'classes': ['Rogue', 'Trickster', 'Shadowblade'], 'desc': "It screams at a frequency only the wearer can hear. You get used to it. That's the worst part."},
...
HEADGEAR = {
    ...
    'tunnel_scouts_hood': {'name': "Tunnel Scout's Hood", 'defense_bonus': 2, 'value': 1250, 'tier': 4, 'droppable_only': True, 'classes': ['Ranger', 'Hunter', 'Warden']},
    'scholars_ashen_cowl': {'name': "Scholar's Ashen Cowl", 'defense_bonus': 1, 'value': 1300, 'tier': 4, 'droppable_only': True, 'classes': ['Mage', 'Wizard', 'Necromancer']},
    'cowl_of_the_blind_leech': {'name': 'Cowl of the Blind Leech', 'defense_bonus': 2, 'value': 1250, 'tier': 4, 'droppable_only': True, 'classes': ['Rogue', 'Trickster', 'Shadowblade'], 'desc': 'A hood that covers the eyes. The wearer sees nothing, but feels the pulse of every living thing.'},
    ...
    'void_stalkers_cowl': {'name': "Void Stalker's Cowl", 'defense_bonus': 2, 'value': 2500, 'tier': 5, 'droppable_only': True, 'classes': ['Ranger', 'Hunter', 'Warden']},
    'resonance_diadem_spine': {'name': 'Crystalline Mind-Crown', 'defense_bonus': 2, 'value': 2600, 'tier': 5, 'droppable_only': True, 'classes': ['Mage', 'Wizard', 'Necromancer'], 'desc': "Grown from a shard of the mountain's core. It whispers solutions to problems you haven't encountered yet."},
    'lurking_shadows_hood': {'name': "Lurking Shadow's Hood", 'defense_bonus': 2, 'value': 2500, 'tier': 5, 'droppable_only': True, 'classes': ['Rogue', 'Trickster', 'Shadowblade'], 'desc': "Woven from darkness itself. The wearer's face becomes difficult to remember."},
...
BOOTS = {
    ...
    'tunnel_runners_boots': {'name': "Tunnel Runner's Boots", 'defense_bonus': 2, 'value': 1250, 'tier': 4, 'droppable_only': True, 'classes': ['Ranger', 'Hunter', 'Warden']},
    'emberwalk_slippers': {'name': 'Emberwalk Slippers', 'defense_bonus': 1, 'value': 1300, 'tier': 4, 'droppable_only': True, 'classes': ['Mage', 'Wizard', 'Necromancer']},
    'striders_of_the_abyss': {'name': 'Striders of the Abyss', 'defense_bonus': 2, 'value': 1250, 'tier': 4, 'droppable_only': True, 'classes': ['Rogue', 'Trickster', 'Shadowblade'], 'desc': 'They make absolutely no sound. The perfect boots for abandoning your friends to the dark.'},
    ...
    'abyssal_striders': {'name': 'Abyssal Striders', 'defense_bonus': 2, 'value': 2500, 'tier': 5, 'droppable_only': True, 'classes': ['Ranger', 'Hunter', 'Warden']},
    'pulse_walkers_treads': {'name': "Pulse-Walker's Treads", 'defense_bonus': 2, 'value': 2600, 'tier': 5, 'droppable_only': True, 'classes': ['Mage', 'Wizard', 'Necromancer'], 'desc': "Boots that step in time with the mountain's heartbeat. You cannot walk off-rhythm."},
    'shadow_step_boots': {'name': 'Shadow-Step Boots', 'defense_bonus': 2, 'value': 2500, 'tier': 5, 'droppable_only': True, 'classes': ['Rogue', 'Trickster', 'Shadowblade']},
...
ACCESSORIES = {
    ...
    'bone_tooth_necklace': {'name': 'Bone-Tooth Necklace', 'defense_bonus': 1, 'value': 1250, 'tier': 4, 'droppable_only': True, 'classes': ['Ranger', 'Hunter', 'Warden']},
    'resonance_warped_ring': {'name': 'Resonance-Warped Ring', 'defense_bonus': 1, 'value': 1300, 'tier': 4, 'droppable_only': True, 'classes': ['Mage', 'Wizard', 'Necromancer'], 'desc': 'A band of crystal that absorbs light. The crystal is cracked.'},
    'lockpicks_of_the_damned': {'name': 'Lockpicks of the Damned', 'value': 1250, 'tier': 4, 'droppable_only': True, 'classes': ['Rogue', 'Trickster', 'Shadowblade'], 'desc': 'Shaped from the finger bones of a thief who died mid-pick. They fit every lock in the Spine.', 'defense_bonus': 0},
    ...
    'deep_watcher_charm': {'name': "Deep Watcher's Charm", 'defense_bonus': 1, 'value': 2500, 'tier': 5, 'droppable_only': True, 'classes': ['Ranger', 'Hunter', 'Warden']},
    'crystalline_focus_ring': {'name': 'Crystalline Focus Ring', 'defense_bonus': 1, 'value': 2600, 'tier': 5, 'droppable_only': True, 'classes': ['Mage', 'Wizard', 'Necromancer']},
    'marrow_bite_ring': {'name': 'Marrow-Bite Ring', 'value': 2500, 'tier': 5, 'droppable_only': True, 'classes': ['Rogue', 'Trickster', 'Shadowblade'], 'desc': 'The band is carved from a single tooth. It bites back if you try to remove it.', 'defense_bonus': 0},
