...
FISH = {
    ...
    "the_pale_king": {
        "name": "The Pale King",
        "category": "legendary", "weight_range": (30.0, 180.0), "sell_value": 800,
        "seasons": _WI, "time_of_day": _NIGHT, "bait_pref": ["crystal_bait"],
        "desc": "An albino pike the length of a man. Seen twice in living memory. Once was enough.",
    },
    "old_aeridor": {
        "name": "Old Aeridor",
        "category": "legendary", "weight_range": (40.0, 200.0), "sell_value": 1200,
    ...
    "tricklemother": {
        ...
        "category": "legendary", "weight_range": (25.0, 150.0), "sell_value": 1000,
    ...
    "moonwarden": {
        "name": "Moonwarden",
        "category": "legendary", "weight_range": (35.0, 180.0), "sell_value": 1400,
    ...
    "sentinel_of_the_deep": {
        ...
        "category": "legendary", "weight_range": (30.0, 170.0), "sell_value": 1300,
        "seasons": _ALL_S, "time_of_day": _NIGHT, "bait_pref": ["crystal_bait"],
        "desc": "Watches from below. Was caught once. Released. Still watching.",
    },
    "crown_of_the_brook": {
        "name": "Crown of the Brook",
        "category": "legendary", "weight_range": (40.0, 200.0), "sell_value": 2000,
        "seasons": _SP, "time_of_day": _DAWN, "bait_pref": ["crystal_bait"],
    ...
    "trickle_end": {
        ...
        "category": "mythic", "weight_range": (50.0, 999.0), "sell_value": 30000,
        "seasons": _WI, "time_of_day": _NIGHT, "bait_pref": ["crystal_bait"],
