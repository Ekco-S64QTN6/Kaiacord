...
FISH = {
    ...
    "whisperpike": {
        "name": "Whisperpike",
        "category": "epic", "weight_range": (20.0, 80.0), "sell_value": 300,
        "seasons": _AU_WI, "time_of_day": _NIGHT, "bait_pref": ["aeridor_lure"],
        "desc": "The Whisperwood's apex freshwater predator. Near-black.",
    },
    "deep_titan_catfish": {
        "name": "Deep Titan Catfish",
        "category": "epic", "weight_range": (25.0, 100.0), "sell_value": 300,
        "seasons": _WI, "time_of_day": _NIGHT, "bait_pref": ["aeridor_lure"],
    ...
    "void_serpent_eel": {
        ...
        "category": "epic", "weight_range": (8.0, 50.0), "sell_value": 300,
    ...
    "iron_pike": {
        "name": "Iron Pike",
        "category": "epic", "weight_range": (15.0, 65.0), "sell_value": 300,
        "seasons": _AU_WI, "time_of_day": _DAWN, "bait_pref": ["aeridor_lure"],
        "desc": "Scales feel metallic. Grey-blue. Enormous. Devastating pull.",
    },
    "rune_pike": {
        "name": "Rune Pike",
        "category": "epic", "weight_range": (12.0, 60.0), "sell_value": 300,
        "seasons": _ALL_S, "time_of_day": _NIGHT, "bait_pref": ["aeridor_lure", "crystal_bait"],
    ...
    "elder_pike": {
        "name": "Elder Pike",
        "category": "epic", "weight_range": (18.0, 75.0), "sell_value": 300,
        "seasons": _WI, "time_of_day": _DAWN, "bait_pref": ["aeridor_lure"],
    ...
    "resonance_giant_carp": {
        ...
        "category": "epic", "weight_range": (15.0, 70.0), "sell_value": 300,
    ...
    "blood_moon_bass": {
        ...
        "category": "epic", "weight_range": (10.0, 55.0), "sell_value": 300,
    ...
    "frozen_king_char": {
        ...
        "category": "epic", "weight_range": (12.0, 58.0), "sell_value": 300,
        "seasons": _WI, "time_of_day": _NIGHT, "bait_pref": ["aeridor_lure", "crystal_bait"],
    ...
    "whisper_leviathan": {
        ...
        "category": "epic", "weight_range": (15.0, 75.0), "sell_value": 300,
    ...
    "old_aeridor": {
        "name": "Old Aeridor",
        "category": "legendary", "weight_range": (50.0, 95.0), "sell_value": 800,
    ...
    "tricklemother": {
        ...
        "category": "legendary", "weight_range": (35.0, 75.0), "sell_value": 800,
    ...
    "moonwarden": {
        "name": "Moonwarden",
        "category": "legendary", "weight_range": (45.0, 90.0), "sell_value": 800,
    ...
    "thorn_serpent": {
        "name": "Thorn Serpent",
        "category": "legendary", "weight_range": (25.0, 65.0), "sell_value": 800,
    ...
    "trickle_end": {
        ...
        "category": "mythic", "weight_range": (75.0, 160.0), "sell_value": 2500,
        "seasons": _WI, "time_of_day": _NIGHT, "bait_pref": ["crystal_bait"],
