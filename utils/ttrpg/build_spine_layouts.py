...
F1M = {
    ...
    "O":{"type":"boss","name":"Foreman's Office","desc":"Kregg is here. He didn't leave with the others.","monster_key":"iron_giant_ff","boss_name":"Foreman Kregg"}
}
...
F2M = {
    ...
    "R":{"type":"boss","name":"The Unburied's Tomb","desc":"It was buried here. It dug itself out.","monster_key":"balor_dd","boss_name":"The Unburied"}
}
...
F3M = {
    ...
    "Q":{"type":"boss","name":"Warden's Chamber","desc":"It was built to guard this forge. It never stopped.","monster_key":"red_dragon","boss_name":"Resonance Warden"}
}
...
F4M = {
    ...
    "S":{"type":"boss","name":"The Last of the Party","desc":"It used to be an adventurer. Now it remembers being one.","monster_key":"tiamat_avatar","boss_name":"The Last of the Party"}
}
...
F5M = {
    ...
    "P":{"type":"boss","name":"The Architect's Prison","desc":"It built the mountain. They buried it inside its own work.","monster_key":"omega","boss_name":"The Bound Architect"}
}
